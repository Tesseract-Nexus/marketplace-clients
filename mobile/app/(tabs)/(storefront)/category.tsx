          ...
          <View className="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <View className="p-3">
              ...
              <View className="mt-1 flex-row items-baseline">
                <Text className="font-bold text-indigo-600">{formatCurrency(item.price)}</Text>
  ...
  const renderHeader = useCallback(() => {
    ...
    return (
      <View>
        {/* Category Header */}
        {category.image_url ? (
          <Image className="h-40 w-full" resizeMode="cover" source={{ uri: category.image_url }} />
        ) : null}
        ...
        <View className="p-4">
          ...
          <Text className="mt-1 text-sm text-gray-400">{category.product_count} products</Text>
        </View>
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  className={`rounded-full px-4 py-2 ${
                    (item.id === null && !selectedSubcategory) || item.id === selectedSubcategory
                      ? 'bg-indigo-600'
                      : 'bg-gray-100'
                  }`}
        ...
        <View className="mb-4 flex-row items-center justify-between px-4">
          ...
          >
            <Ionicons color="#6b7280" name="swap-vertical-outline" size={18} />
  ...
  const renderEmpty = useCallback(() => {
    ...
    return (
      <View className="flex-1 items-center justify-center py-16">
        <Ionicons color="#d1d5db" name="cube-outline" size={48} />
