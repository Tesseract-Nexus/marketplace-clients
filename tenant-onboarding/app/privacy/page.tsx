        ...
        <div className="max-w-3xl mx-auto">
          <div className="prose prose-lg text-foreground-secondary space-y-8">
            ...
            <section>
              ...
              <p className="leading-relaxed mt-4">
                To exercise your rights, email <a href="mailto:privacy@mark8ly.app" className="text-primary hover:underline">privacy@mark8ly.app</a>. We'll respond within 30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-warm-50 border border-warm-200 rounded-lg">
                <p className="m-0"><strong>Email:</strong> <a href="mailto:privacy@mark8ly.app" className="text-primary hover:underline">privacy@mark8ly.app</a></p>
                <p className="mt-2 mb-0"><strong>Data Protection Officer:</strong> <a href="mailto:dpo@mark8ly.app" className="text-primary hover:underline">dpo@mark8ly.app</a></p>
              </div>
              <p className="leading-relaxed mt-4">
