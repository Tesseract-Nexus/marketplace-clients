          ...
          <div className="prose prose-lg text-foreground-secondary space-y-8">
            ...
            <div className="p-6 bg-warm-50 rounded-xl border border-warm-200">
              <p className="text-foreground leading-relaxed m-0">
                Welcome to Tesseract Hub. These Terms of Service govern your use of our platform and services. By using Tesseract Hub, you agree to these Terms. We've written these in plain language, but they're still a legal agreement.
              </p>
            </div>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                By creating a Tesseract Hub account or using our services, you agree to these Terms of Service, our Privacy Policy, and our Acceptable Use Policy.
              </p>
              <p className="leading-relaxed mt-4">
                <strong>Age Requirement:</strong> You must be at least 18 years old to use Tesseract Hub.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                We offer refunds within 14 days of purchase. Contact support@tesseracthub.com. After 14 days, charges are non-refundable, but you can cancel anytime.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="font-medium text-foreground text-lg mt-6 mb-3">You May Not Use Tesseract Hub To</h3>
            ...
            <section>
              ...
              <p className="leading-relaxed mt-2">
                <strong>Our Property:</strong> Tesseract Hub, our logo, and platform are protected by intellectual property laws.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Tesseract Hub is provided "as is." We don't guarantee sales, revenue, or that the service will be uninterrupted or error-free.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                To the fullest extent permitted by law, Tesseract Hub's total liability is limited to the amount you paid us in the 12 months before the claim arose. We're not liable for lost profits, lost data, or indirect damages.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                <strong>Informal Resolution:</strong> If you have a dispute, contact us first at legal@tesseracthub.com. We'll work in good faith to resolve it.
              </p>
              <p className="leading-relaxed mt-4">
                <strong>Governing Law:</strong> These Terms are governed by the laws of India. Disputes will be resolved in the courts of Karnataka, India.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-warm-50 border border-warm-200 rounded-lg">
                <p className="m-0"><strong>Legal Questions:</strong> <a href="mailto:legal@tesseracthub.com" className="text-primary hover:underline">legal@tesseracthub.com</a></p>
                <p className="mt-2 mb-0"><strong>General Support:</strong> <a href="mailto:support@tesseracthub.com" className="text-primary hover:underline">support@tesseracthub.com</a></p>
              </div>
            </section>
            ...
            <section className="mt-12 p-6 bg-sage-50 rounded-xl border border-sage-200">
              <p className="text-sage-700 font-medium m-0 text-center">
                Thank you for choosing Tesseract Hub. We're honored to be part of your business journey.
              </p>
            </section>
