...
export default function CreateIndependentStorePage() {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-500">
        <PageHeader
          ...
          description="Set up a new business with complete data isolation"
          breadcrumbs={[
            { label: 'Home', href: '/' },
            { label: 'Stores', href: '/stores' },
            { label: 'Create Independent Store' },
          ]}
        />
        ...
        {step === 1 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter the basic details for your new independent store
              </CardDescription>
            </CardHeader>
                ...
                <div className="relative">
                  <div className="flex items-center">
                    <span className="px-3 h-10 flex items-center bg-muted border border-r-0 border-border rounded-l-md text-muted-foreground text-sm">
                      admin.{process.env.NEXT_PUBLIC_BASE_DOMAIN || 'mark8ly.com'}/
                    </span>
                    <input
                      type="text"
                      value={formData.slug}
              ...
              <div className="p-6 bg-muted rounded-xl border-2 border-border">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">admin.{process.env.NEXT_PUBLIC_BASE_DOMAIN || 'mark8ly.com'}/{formData.slug || 'your-slug'}</p>
              ...
              <div className="p-4 bg-primary/10 rounded-xl border border-primary/30">
                ...
                <ul className="text-sm text-primary space-y-1">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4" />
                    A new independent store will be created
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4" />
