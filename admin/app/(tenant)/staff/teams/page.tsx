              ...
              <div className="flex items-center gap-3">
                ...
                {canCreateTeams && (
                  <Button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
                  >
                            ...
                            <div className="flex items-center justify-end gap-1">
                              ...
                              {canUpdateTeams && (
                                <Button
                                  ...
                                  title="Edit"
                                >
                                  <Edit className="w-4 h-4 text-violet-700" />
                                </Button>
                              )}
                              {canDeleteTeams && (
                                <Button
