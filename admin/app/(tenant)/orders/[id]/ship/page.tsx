                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        <input
                          ...
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-ring focus:border-primary"
                          placeholder="Length"
                          min="1"
                        />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-ring"
                      />
                    </div>
                    <div>
