...
export function AnalyticsProvider({ children }: { children: React.ReactNode }) {
  ...
  const analytics = settings.analyticsConfig;

  // If no analytics config, just render children
  if (!analytics) {
    return <>{children}</>;
  }
        ...
        <>
          ...
          <Script id="ga4" strategy="afterInteractive">
            {`
              ...
              gtag('js', new Date());
              gtag('config', '${analytics.googleAnalyticsId}'${analytics.enableEnhancedEcommerce ? ", { 'enhanced_ecommerce': true }" : ''});
            `}
          </Script>
        </>
      )}
      ...
      {analytics.pinterestTagId && (
        <Script id="pinterest-tag" strategy="afterInteractive">
          {`
            ...
            pintrk('load', '${analytics.pinterestTagId}');
            pintrk('page');
          `}
        </Script>
      )}
      ...
      {analytics.snapchatPixelId && (
        <Script id="snapchat-pixel" strategy="afterInteractive">
          {`
            ...
            snaptr('init', '${analytics.snapchatPixelId}');
